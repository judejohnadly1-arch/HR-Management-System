...
values ('10-10-2025','11-26-2025','12-01-2025','approved') 
...
insert into leave (date_of_request,start_date,end_date
,final_approval_status)
values ('10-26-2025','10-22-2025','11-22-2025','pending')
...
insert into leave (date_of_request,start_date,end_date
,final_approval_status)
values ('12-13-2025','12-13-2025','09-09-2025','approved')
...
insert into leave (date_of_request,start_date,end_date
,final_approval_status)
values ('12-2-2025','01-13-2026','03-13-2026','rejected')
...
insert into leave (date_of_request,start_date,end_date
,final_approval_status)
values ('11-13-2025','11-13-2025','03-13-2026','rejected')
select * from Leave join Annual_Leave on Leave.request_ID=Annual_Leave.request_ID
insert into Annual_Leave (request_ID,emp_ID,replacement_emp)
values (24,1,2)

select * from Annual_Leave left outer join Leave on Annual_Leave.request_ID=Leave.request_ID
select * from Leave where start_date>='11-01-2025'
select * from Accidental_Leave  left outer join Leave on Accidental_Leave.request_ID=Leave.request_ID
---------------
...
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('12-01-2025',null,null,'absent',1)
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('11-8-2025',null,null,'attended',1)
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('10-15-2025','08:30','16:00','attended',1)
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('12-04-2025','08:30','17:30','absent',2)
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('12-03-2025','08:35','17:30','absent',2)
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('12-02-2025','08:30','17:30','absent',2)
insert into Attendance (date,check_in_time,check_out_time,status,emp_ID)
values ('10-01-2025','08:30','17:30','absent',2)
...
insert into Deduction (emp_ID,date,amount,type,
status,unpaid_ID,attendance_ID)
values (2,'10-01-2025',3266.66,'missing_hours','finalized',null,13)
select * from Deduction
insert into Deduction (emp_ID,date,amount,type,
status,unpaid_ID,attendance_ID)
values (2,'10-01-2025',3266.66,'missing_hours','finalized',null,11)
insert into Deduction (emp_ID,date,amount,type,
status,unpaid_ID,attendance_ID)
values (2,'10-01-2025',3266.66,'missing_hours','finalized',null,12)
insert into Deduction (emp_ID,date,amount,type,
status,unpaid_ID,attendance_ID)
values (2,'10-01-2025',3266.66,'missing_hours','finalized',null,14)



------------------
insert into Payroll (payment_date,final_salary_amount,from_date,to_date,comments,bonus_amount,deductions_amount,emp_ID)
values ('10-01-2025',38666.67,'11-01-2025','11-30-2025','Has deduction',0,1333.33,2)
insert into Payroll (payment_date,final_salary_amount,from_date,to_date,comments,bonus_amount,deductions_amount,emp_ID)
values ('09-01-2025',17600 ,'11-01-2025','11-31-2025','unpaid Leave',0,30400,2)
insert into Payroll (payment_date,final_salary_amount,from_date,to_date,comments,bonus_amount,deductions_amount,emp_ID)
...
insert into Payroll (payment_date,final_salary_amount,from_date,to_date,comments,bonus_amount,deductions_amount,emp_ID)
values ('11-01-2025',33600 ,'09-01-2025','09-30-2025','unpaid Leave',0,14400,2)
