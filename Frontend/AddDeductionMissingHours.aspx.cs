...
namespace M3_team3
{
    public partial class AddDeductionMissingHours : System.Web.UI.Page
    {
        protected void btn_missingHours(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connStr))
            {
                ...
                try
                {
                    conn.Open();
                    cmd.ExecuteNonQuery();
                    lblMessage.Text = "Missing hours deduction added successfully for Employee ID: " + empId;
