<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveRejectCompensation.aspx.cs" Inherits="M3_team3.ApproveCompensation" %>
    ...
    <form id="form1" runat="server">
        <div class="leave-page-wrapper">
            <div class="leave-card">
                <asp:Label ID="Label1" runat="server" Text="Approve/Reject Compensation Leaves" Font-Bold="true" Font-Size="Large"></asp:Label>
                <br /><br />
